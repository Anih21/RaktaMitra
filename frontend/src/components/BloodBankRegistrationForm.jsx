...
import { FaArrowLeft, FaArrowRight, FaEye, FaEyeSlash, FaCheck, FaUser, FaBuilding, FaMapMarkerAlt, FaWarehouse } from 'react-icons/fa';
import MaharashtraMapSelector from './MaharashtraMapSelector';
import '../styles/auth.css';

const BLOOD_GROUPS = ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'];

export default function BloodBankRegistrationForm({ onSuccess, onBack }) {
    ...
    const steps = [
        ...
        { label: 'Bank Details', icon: FaBuilding },
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                // blood bank specific profile details
                bloodBankName: formData.bloodBankName,
                licenceNumber: formData.licenceNumber,
                profilePhone: formData.phone, // phone field on bloodbank profile schema
            ...
            <div className="registration-wrapper">
                <div className="registration-card">
                    <div className="registration-header">
                        ...
                        <p>Join the network to manage inventory and save lives</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        {/* STEP 2: Blood Bank Profile Details */}
                        {currentStep === 1 && (
                            <div className="step-content">
                                <div className="form-group">
                                    <label>Blood Bank Registered Name</label>
                                    <input
                                        type="text"
                                        name="bloodBankName"
                                        ...
                                        className={errors.bloodBankName ? 'input-error' : ''}
                                    />
                                    {errors.bloodBankName && <span className="error-text">{errors.bloodBankName}</span>}
                                </div>
